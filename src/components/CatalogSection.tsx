...
const CatalogSection = () => {
	...
	return (
		<section id='catalog' className='py-12 md:py-24 px-3 md:px-6'>
            ...
            1. gap-2 (8px) для мобилок, чтобы карточки влезли.
            2. w-[calc(50%-0.5rem)] - это строгая математика: 50% ширины минус половина отступа (gap-2 = 0.5rem).
               Это гарантирует, что 2 карточки всегда встанут в ряд.
        */}
				...
				{isLoading ? (
					<div className='flex flex-wrap justify-center gap-2 md:gap-6'>
						{[...Array(5)].map((_, i) => (
							...
							>
								<div className='w-12 h-12 md:w-20 md:h-20 mx-auto mb-3 rounded-xl bg-muted' />
							...
							return (
								...
								>
									...
									<div>
										...
										{product.image_url ? (
											<div className='w-12 h-12 md:w-20 md:h-20 mx-auto mb-3 md:mb-6 rounded-xl overflow-hidden shadow-sm'>
												<img
											...
											<div className='gold-bar-icon w-12 h-12 md:w-20 md:h-20 mx-auto mb-3 md:mb-6 rounded-xl shadow-lg shadow-gold/10'>
										...
										{/* Характеристики (уменьшен шрифт для мобилок) */}
									...
									<a
										...
										className='w-full btn-gold-soft text-[10px] md:text-sm py-2 md:py-2.5 flex items-center justify-center gap-1.5 md:gap-2 group-hover:bg-gold/20 rounded-lg'
									>
										<svg
